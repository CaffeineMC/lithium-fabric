...
public abstract class MixinPointOfInterestStorage extends SerializingRegionBasedStorage<PointOfInterestSet> {
     ...
     */
    @Overwrite
    public Optional<BlockPos> getNearestPosition(Predicate<PointOfInterestType> pointPredicate, Predicate<BlockPos> posPredicate, BlockPos pos, int radius, PointOfInterestStorage.OccupationStatus status) {
