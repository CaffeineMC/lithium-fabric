...
public class ChunkHolderMixin implements ChunkHolderExtended {
    ...
    @Override
    public CompletableFuture<OptionalChunk<Chunk>> getFutureByStatus(int index) {
        return this.futuresByStatus.get(index);
    }

    @Override
    public void setFutureForStatus(int index, CompletableFuture<OptionalChunk<Chunk>> future) {
